    ...
    j.fn.dataTable = function (g) {
        ...
        function F(a, b) {
            ...
            if (typeof a.aoPreSearchCols[b] == "undefined" || a.aoPreSearchCols[b] ===
                null) a.aoPreSearchCols[b] = { sSearch: "", bRegex: false, bSmart: true }; else {
            ...
            for (d = a.aoColumns.length; h < d; h++) {
                ...
                if (f || e || k || !l) {
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (l) a.aoData[b]._anHidden[h] = null; else {
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), f, e, i, h, k, l, q, t = 0; t < d.length; t++) {
                ...
                if (i == "<") {
                    ...
                    if (k == "'" || k == '"') {
                        ...
                        if (l == "H") l = "fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix"; else if (l == "F") l = "fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
                        if (l.indexOf(".") != -1) {
                            k = l.split(".");
                    ...
                    var e = function () {
                        ...
                        if (f.shiftKey) {
                            for (var k = false, l = 0; l < a.aaSorting.length; l++) if (a.aaSorting[l][0] == c) {
                                ...
                                i = a.aaSorting[l][0];
                                h = a.aaSorting[l][2] + 1;
                                if (typeof a.aoColumns[i].asSorting[h] == "undefined") a.aaSorting.splice(l, 1); else {
        ...
        function ma(a, b) {
            for (var c =
                -1, d = 0, f = a.length; d < f; d++) if (a[d] == b) c = d; else a[d] > b && a[d]--;
            c != -1 && a.splice(c, 1)
        }
        ...
        return this.each(function () {
            ...
            if (this.nodeName.toLowerCase() != "table") H(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName); else {
                e.oInstance = Na;
                e.nTable = this;
                e.oApi = Na.oApi;
                ...
                if (typeof g.aoColumnDefs != "undefined") for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                    ...
                    } else if (typeof l[c] == "number" && l[c] < 0) x(e, e.aoColumns.length + l[c], g.aoColumnDefs[a]); else if (typeof l[c] == "string") {
                        b = 0;
